...
load_dotenv()  # Carrega as variáveis do .env antes de tudo
...
app = Flask(__name__)  # Inicializa o app aqui, antes das rotas

# Configura o Cloudinary com as variáveis de ambiente carregadas
cloudinary.config(
...
# DEBUG: Confirma se as variáveis foram carregadas
